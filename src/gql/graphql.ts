...
export type AlbumQuery = { __typename?: 'query_root', album_by_pk?: { __typename?: 'album', album_id: number, title: string, subtitle?: string | null, icon?: string | null, background?: string | null, created_by: any, upload_path: string, images: Array<{ __typename?: 'image', image_id: number, path: string, width?: number | null, height?: number | null }> } | null };

export type MyAlblumsQueryVariables = Exact<{ [key: string]: never; }>;


export type MyAlblumsQuery = { __typename?: 'query_root', album: Array<{ __typename?: 'album', album_id: number, created_at: any, title: string, subtitle?: string | null, icon?: string | null, background?: string | null, upload_path: string, images: Array<{ __typename?: 'image', image_id: number, path: string, size?: number | null, width?: number | null, height?: number | null }> }> };
...
export type InsertAlbumMutation = { __typename?: 'mutation_root', insert_album_one?: { __typename?: 'album', album_id: number, created_at: any, created_by: any, title: string, subtitle?: string | null, icon?: string | null, background?: string | null, upload_path: string } | null };
